...
type SignedToken_Header struct {
	EncAlg  string `protobuf:"bytes,1,opt,name=encAlg" json:"encAlg,omitempty"`
	TimeAlg string `protobuf:"bytes,2,opt,name=timeAlg" json:"timeAlg,omitempty"`
...
func (m *SignedToken_Header) GetEncAlg() string {
	if m != nil {
		return m.EncAlg
	}
	return ""
...
func (m *SignedToken_Header) GetTimeAlg() string {
	if m != nil {
		return m.TimeAlg
	}
	return ""
...
type SignedToken_Payload struct {
	Username       string `protobuf:"bytes,1,opt,name=username" json:"username,omitempty"`
	ExpirationDate int64  `protobuf:"varint,2,opt,name=expirationDate" json:"expirationDate,omitempty"`
}
...
func (m *SignedToken_Payload) GetExpirationDate() int64 {
	if m != nil {
...
var fileDescriptor0 = []byte{
	...
	,
}
